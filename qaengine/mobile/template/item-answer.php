        	...
        	<div class="col-md-12">
                ...
                <div class="share">
                    <ul class="list-share">
                        ...
                        <li>
                            <a href="javascript:void(0)" class="mb-show-comments" data-post-id="<?php echo $post->ID; ?>"><?php _e("Comment", ET_DOMAIN) ?>(<?php echo $comments_count->approved; ?>)&nbsp;<i class="fa fa-comment"></i></a>
                        </li>
                    </ul>
                </div>
                <!-- SHARE / END -->
                <!-- COMMENT IN COMMENT -->
                <div class="cmt-in-cmt-wrapper" id="list-comment-<?php echo $post->ID; ?>">
                    ...
                    <a href="javascript:void(0)" class="add-cmt-in-cmt" id="btn-add-comment-<?php echo $post->ID; ?>"><?php _e("Add comment", ET_DOMAIN) ?></a>
                </div>
