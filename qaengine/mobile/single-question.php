            	...
            	<div class="col-md-12">
                    ...
                    <div class="share">
                        <ul class="list-share">
                            ...
                            <li>
                                <a href="javascript:void(0)" class="mb-show-comments" data-post-id="<?php echo $post->ID; ?>">
                                    <?php _e("Comment", ET_DOMAIN) ?>(<?php echo $comments_count->approved ?>)&nbsp;<i class="fa fa-comment"></i>
                                </a>
                            </li>
                        </ul>
                    </div>
