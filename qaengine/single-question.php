                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-4 question-control">
                        <ul>
                            ...
                            <li>
                                <a href="#container_<?php echo $post->ID ?>" class="show-comments <?php if($comments_count->approved > 0) echo 'active'; ?>">
                                    <?php
                                    printf( __( 'Comment(%d) ', ET_DOMAIN ), $comments_count->approved);
