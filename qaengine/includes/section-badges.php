    ...
    */
    ...
    function render( $first  =   false) {
        ...
        */
    	...
    	echo '<div '. $display .' class="et-main-main clearfix inner-content pack-control '. $this->field['class'] .'" id="'. $this->field['id'] .'"  data-option-name="qa_level" data-template="qa_level" >';
    ?>
			...
			<!-- <div class="inner"> -->
				<div id="payment_lists">
					<ul class="pay-plans-list">	
						...
						<script type="application/json" id="ae_list_qa_level">
							<?php echo json_encode($pack_list); ?>
						</script>
					</ul>
					<input id="confirm_delete_qa_level" value="<?php _e("Are you sure you want to delete this badge?", ET_DOMAIN); ?>" type="hidden" />
				</div>
				<div class="item">
				...
				<script type="text/template" id="ae-template-qa_level">
