    ...
    */
    ...
    function get_default_options() {
        ...
        return array(
            ...
            // default new member registration template
            'register_mail_admin_template'   => '<p>Hi [display_name],</p>
                                                <p>There is a new member registration on your site [blogname].</p>
    ...
    function admin_setup() {
        ...
        $sections[] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args'  => array(
                        'title' => __("New Member Registration Email", ET_DOMAIN) ,
                        'id'    => 'new-member-email',
                        'class' => '',
                        'desc'  => __("Enabling this will allow you to receive email notification when there is a new member on your site.", ET_DOMAIN)
                    ) ,
        ...
        $sections[] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("New Member Registration Template", ET_DOMAIN) ,
                        'id'    => 'register-mail-admin',
                        'class' => '',
                        'name'  => ''
                    ) ,
                    'fields' => array(
                        array(
                            'id'    => 'register_mail_admin_template',
                            'type'  => 'editor',
                            'title' => __("New Member Registration", ET_DOMAIN) ,
                            'name'  => 'register_mail_admin_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
