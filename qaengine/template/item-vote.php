<?php
    global $post, $qa_answer, $qa_question, $current_user, $user_ID;
...
<div class="col-md-2 col-xs-2 vote-block">
    ...
    <ul>
		...
		<?php
            if(is_singular( 'question' ) ){
        		...
        		if($post->post_type == 'answer' )  {
                    ...
                    if($qa_answer->check_role_best_answer){
                        ...
                        ?>
                        <li title="<?php _e('Mark as best answer', ET_DOMAIN); ?>">
                            <a href="javascript:void(0)"
                                <?php echo $data_name; ?>
                               class="action accept-answer img-circle <?php echo $active ?>">
       ...
       <li class="single-question-pump">
           <?php qa_render_pump_button($qa_question); ?>
       </li>
    </ul>
    <!--// vote group -->
</div>